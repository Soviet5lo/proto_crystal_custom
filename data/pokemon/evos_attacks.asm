...
WeepinbellEvosAttacks:
	...
	db EVOLVE_ITEM, POISON_STONE, BELLMITT
	db 0 ; no more evolutions
	db 1, VINE_WHIP
	db 1, GROWTH
	db 1, WRAP
...
TrifoxEvosAttacks:
	...
	db 1, CHARM
	db 3, TAIL_WHIP
	db 6, HYPNOSIS ; G/S/C Egg move
	db 8, EMBER
	db 10, FORESIGHT ; Spaceworld move
	db 12, ROAR
	db 0 ; no more level-up moves
...
TangelEvosAttacks:
	...
	db 4, SLEEP_POWDER
	db 7, ABSORB
	db 10, FLAIL ; G/S/C Egg move
	db 13, POISONPOWDER
	db 16, VINE_WHIP
	db 19, SWEET_KISS
	db 22, CONFUSION ; G/S/C Egg move
	db 0 ; no more level-up moves
...
ParasyEvosAttacks:
	...
	db 4, STUN_SPORE
	db 7, LEECH_LIFE
	db 10, FURY_SWIPES ; Spaceworld move
	db 12, FALSE_SWIPE ; G/S/C Egg move
	db 0 ; no more level-up moves
...
MeowsyEvosAttacks:
	...
	db 1, CHARM
	db 4, GROWL
	db 7, TAIL_WHIP ; Spaceworld move
	db 10, BITE
	db 13, HYPNOSIS ; G/S/C Egg move
	db 0 ; no more level-up moves
...
MinicornEvosAttacks:
	...
	db 7, TAIL_WHIP
	db 10, EMBER
	db 13, QUICK_ATTACK ; G/S/C Egg move
	db 16, STOMP
	db 19, DOUBLE_KICK ; G/S/C Egg move
	db 0 ; no more level-up moves
...
PuddiEvosAttacks:
	...
	db 4, ROAR
	db 7, EMBER
	db 10, QUICK_ATTACK ; Spaceworld move
	db 13, BITE
	db 0 ; no more level-up moves

LefmewEvosAttacks:
	db EVOLVE_LEVEL, 18, DANDEMEW
	db 0 ; no more evolutions
	db 1, SPLASH
if _CRYSTAL
	db 5, SYNTHESIS
...
BallerineEvosAttacks:
	...
	db 1, CHARM
	db 1, BARRIER
	db 4, MIMIC ; G/S/C Egg move
	db 7, ENCORE
	db 10, HYPNOSIS ; G/S/C Egg move
	db 14, SWEET_KISS
	db 0 ; no more level-up moves
...
SmoochumEvosAttacks:
	...
	db 7, DOUBLESLAP
	db 10, POWDER_SNOW
	db 13, LOVELY_KISS ; G/S/C Egg move
	db 0 ; no more level-up moves
...
ElekidEvosAttacks:
	...
	db 1, LEER
	db 1, CHARM
	db 4, THUNDER_WAVE ; Spaceworld move
	db 7, THUNDERPUNCH
	db 10, THUNDERSHOCK ; Spaceworld move
	db 14, SPARK ; Spaceworld move
	db 0 ; no more level-up moves

MagbyEvosAttacks:
	db EVOLVE_LEVEL, 15, MAGMAR
	db 0 ; no more evolutions
	db 1, SCRATCH ; Spaceworld move
	db 1, LEER
	db 1, CHARM
	db 4, SCREECH ; Egg move
	db 7, FIRE_PUNCH
	db 10, SMOG
	db 13, EMBER
	db 0 ; no more level-up moves
